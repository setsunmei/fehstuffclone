gok! function e(a, r, t)
{
	function i(o, s)
	{
		if (!r[o])
		{
			...
			a[o][0].call(m.exports, function (e)
			{
				var r = a[o][1][e];
				return i(r || e)
			}, m, m.exports, e, a, r, t)
	...
	for (var n = "function" == typeof require && require, o = 0; o < t.length; o++) i(t[o]);
	return i
}(
{
	1: [function (e, a, r)
	{
		"use strict";
		let t = e("./banner-data.js"),
			i = e("./banner-rates-data.js");
		t.forEach(e =>
		{
			e.banners.forEach(e =>
			{
				e.rates = i[e.rateType]
			})
		}), r.getAllBanners = function ()
		{
			return t
		}, r.getFirstBanner = function ()
		{
			return t[0].banners[0]
		}
	},
	{
		"./banner-data.js": 2,
		"./banner-rates-data.js": 3
	}],
	2: [function (e, a, r)
	{
		a.exports = [
		...
		},
		{
			...
			{
				name: "Heroes with Link Skills",
				startDate: "Feb 02, 2019",
				focusHeroes: ["Laevatein", "Sumia", "Nina"],
				excludeFromRarity4: [],
				excludeFromRarity5: [],
				rateType: "defaultV2",
				pool: "pool2"
		...
		},
		{
			...
			{
				name: "New Power (January 2019)",
				startDate: "Jan 20, 2019",
				focusHeroes: ["Seliph", "Tailtiu", "Deirdre", "Julia"],
				excludeFromRarity4: [],
				excludeFromRarity5: [],
				rateType: "defaultV2",
				pool: "pool2"
		...
		},
		{
			...
			banners: [
			{
				...
				focusHeroes: ["Gunnthrá", "Leo (Nohrian Summer)", "Olivia (Performing Arts)", "Shiro", "Ike (Brave Heroes)", "Corrin (F) (Nohrian Summer)", "Ike (Legendary Heroes)", "Dorcas", "Mia", "Gaius (Ylissean Summer)", "Jaffar", "Ephraim (Legendary Heroes)"],
				excludeFromRarity4: [],
				excludeFromRarity5: ["Robin (M) (Fallen Heroes)", "Hardin (Fallen Heroes)", "Celica (Fallen Heroes)"],
				rateType: "legendaryV1",
				pool: "pool1"
		...
		},
		{
			...
			banners: [
			{
				...
				focusHeroes: ["Gunnthrá", "Xander (Nohrian Summer)", "Azura (Performing Arts)", "Fjorm", "Lucina (Brave Heroes)", "Robin (F) (Ylissean Summer)", "Ike (Legendary Heroes)", "Sanaki", "Siegbert", "Frederick (Ylissean Summer)", "Takumi", "Faye"],
				excludeFromRarity4: ["L'Arachel"],
				excludeFromRarity5: ["Myrrh", "Eirika (Sacred Memories)", "L'Arachel"],
				rateType: "legendaryV1",
				pool: "pool1"
		...
		},
		{
			...
			},
			{
				...
				focusHeroes: ["Gunnthrá", "Amelia", "Chrom (Spring Festival)", "Fjorm", "Lucina (Spring Festival)", "Charlotte (Bridal Blessings)", "Ryoma", "Sigurd", "Roy (Brave Heroes)", "Elise", "Innes", "Lyn (Bridal Blessings)"],
				excludeFromRarity4: [],
				excludeFromRarity5: [],
				rateType: "legendaryV1",
				pool: "pool1"
	...
	3: [function (e, a, r)
	{
		a.exports = {
			defaultV1:
			{
				...
				rateRarity5: 3,
				rateRarityFocus: 3,
				pityRateRarity3: -58 / 94 * .5,
				pityRateRarity4: -36 / 94 * .5,
				pityRateRarityFocus4: 0,
				pityRateRarity5: .25,
				pityRateRarityFocus: .25
			},
			defaultV2:
			{
				rateRarity3: 36,
				...
				rateRarity5: 3,
				rateRarityFocus: 3,
				pityRateRarity3: -36 / 94 * .5,
				pityRateRarity4: -58 / 94 * .5,
				pityRateRarityFocus4: 0,
				pityRateRarity5: .25,
				pityRateRarityFocus: .25
			},
			herofestV1:
			{
				...
				rateRarity5: 3,
				rateRarityFocus: 5,
				pityRateRarity3: -58 / 92 * .5,
				pityRateRarity4: -34 / 92 * .5,
				pityRateRarityFocus4: 0,
				pityRateRarity5: .1875,
				pityRateRarityFocus: .3125
			},
			herofestV2:
			{
				rateRarity3: 34,
				...
				rateRarity5: 3,
				rateRarityFocus: 5,
				pityRateRarity3: -34 / 92 * .5,
				pityRateRarity4: -58 / 92 * .5,
				pityRateRarityFocus4: 0,
				pityRateRarity5: .1875,
				pityRateRarityFocus: .3125
			},
			...
			focus4V1:
			{
				...
				rateRarityFocus: 3,
				pityRateRarity3: -36 / 94 * .5,
				pityRateRarity4: -29 / 94 * .5,
				pityRateRarityFocus4: -29 / 94 * .5,
				pityRateRarity5: .25,
				pityRateRarityFocus: .25
			}
		}
	...
	{
		"use strict";
		let t = e("./hero-data.js"),
			i = ["Alfonse", "Sharena", "Anna"];

		function n(e, a = !1)
		{
			let r = [];
			for (let a = 0; a < t.length; a++)
				if (!i.includes(t[a].name))
					for (let i = 0; i < t[a].skills.length; i++)
						if (t[a].skills[i].name === e)
						{
							r.push(
							{
								name: t[a].name,
								rarity: t[a].skills[i].rarity,
								rank: t[a].ttReward ? 1.4 : t[a].limited ? 1.3 : t[a].ghb ? 1.2 : t[a].rarity3 ? 1 : 1.1
							});
							break
						}
			return a && r.sort((e, a) => e.rank === a.rank ? e.rarity - a.rarity : e.rank - a.rank), r
		}
		a.exports = {
			...
			getHeroes: function (e)
			{
				return t.filter(a => e.includes(a.name))
			},
			getSummoningPool: function (e, a)
			{
				...
				for (let n = 0; n < t.length; n++) r <= new Date(t[n].releaseDate) || t[n].limited || t[n].ghb || t[n].ttReward || (t[n].rarity3 && t[n].rarity3.includes(e) && i.r3.push(t[n]), t[n].rarity4 && t[n].rarity4.includes(e) && !a.excludeFromRarity4.includes(t[n].name) && i.r4.push(t[n]), t[n].rarity5 && t[n].rarity5.includes(e) && !a.excludeFromRarity5.includes(t[n].name) && i.r5.push(t[n]));
				return i
			},
			getInheritanceList: n,
			getInheritancePrereqList: function (e)
			{
				let a = e.map(e => n(e, !0)),
					r = a[0].reduce((e, a) => Math.min(e, a.rarity), 5),
					t = [];
				a[0] = a[0].filter(e => e.rarity <= r && (t.push(e.name), !0));
				for (let e = 1; e < a.length; e++) a[e] = a[e].filter(e => t.includes(e.name));
				return a
			},
			hasSkill: function (e, a, r)
			{
				for (let t = 0; t < e.skills.length; t++)
					if (e.skills[t].name === a && e.skills[t].rarity <= r) return !0;
				return !1
			}
		}
	},
	...
	5: [function (e, a, r)
	{
		...
		},
		{
			...
			{
				name: "Fortify Armor 1",
				rarity: 5
			},
			{
				name: "Fortify Armor 2",
				rarity: 5
			},
			{
				name: "Fortify Armor 3",
				rarity: 5
			}],
			stats:
			{
	...
	7: [function (e, a, r)
	{
		let t, i = e("../data/hero-access.js"),
			n = e("../data/banner-access.js"),
			o = e("./elements.js"),
			s = e("./values.js"),
			l = {},
			m = {},
		...
		function g(e, a)
		{
			a = a.map(e => parseInt(e)), e.rates = {}, e.rates.rateRarityFocus = Math.max(0, Math.min(100, a[0]));
			let r = 100 - e.rates.rateRarityFocus;
			a[1] >= 0 && a[0] + a[1] <= 100 ? e.rates.rateRarity5 = a[1] : e.rates.rateRarity5 = Math.min(3, r), r -= e.rates.rateRarity5, a[2] >= 0 && a[0] + a[1] + a[2] <= 100 ? e.rates.rateRarityFocus4 = a[2] : e.rates.rateRarityFocus4 = 0, r -= e.rates.rateRarityFocus4, a[3] >= 0 && a[0] + a[1] + a[2] + a[3] <= 100 ? e.rates.rateRarity4 = a[3] : e.rates.rateRarity4 = e.rates.rateRarityFocus4 || Math.min(58, r), e.rates.rateRarity3 = r - e.rates.rateRarity3, e.rates.pityRateRarityFocus = 0 === e.rates.rateRarity5 ? .5 : .25, e.rates.pityRateRarity5 = 0 === e.rates.rateRarity5 ? 0 : .25;
			let t = 100 - e.rates.rateRarityFocus - e.rates.rateRarity5;
			0 === t ? (e.rates.pityRateRarityFocus4 = 0, e.rates.pityRateRarity4 = 0, e.rates.pityRateRarity3 = 0) : (e.rates.pityRateRarityFocus4 = -e.rates.rateRarityFocus4 / t * .5, e.rates.pityRateRarity4 = -e.rates.rateRarity4 / t * .5, e.rates.pityRateRarity3 = -e.rates.rateRarity3 / t * .5)
		}
		...
		function f()
		{
			! function ()
			{
				let e = $(o.FOCUS_LIST).empty(),
					a = i.getHeroes(l.focusHeroes);
				(m = i.getSummoningPool(l.pool, l)).rf = a, a.forEach(a =>
				{
					$(`<div class="focus-list-hero">\n        <img class="focus-list-hero-frame" src="../img/assets/frame-rarity-focus.png">\n        <img class="focus-list-hero-portrait" src="../${a.assets.portrait}">\n        <img class="focus-list-hero-background" src="../img/assets/background-rarity-focus.png">\n        </div>`).tooltip(
					{
						html: !0,
						placement: "bottom",
						title: `<p class="mb-0">${a.title}</p><h6>${a.shortName||a.name}</h6>`
					}).appendTo(e)
				}), u(o.POOL_LIST_5F, m.rf), u(o.POOL_LIST_5, m.r5), u(o.POOL_LIST_4, m.r4), u(o.POOL_LIST_3, m.r3)
			}(), k(), $(o.SNIPE_LIST).empty(), m.rf.forEach(e =>
			{
				let a = $('<input type="checkbox" class="custom-control-input snipe-target">').data("hero", e);
				$('<label class="custom-control custom-checkbox snipe-option"></label>').append(a).append(`<span class="custom-control-indicator"></span>\n            <span class="custom-control-description">${e.name}</span>`).appendTo(o.SNIPE_LIST)
			})
		}

		function u(e, a)
		{
			let r = a.sort((e, a) => e.colorType === a.colorType ? e.weaponType === a.weaponType ? e.name.localeCompare(a.name) : s.POOL_WEAPON_ORDER.indexOf(e.weaponType) - s.POOL_WEAPON_ORDER.indexOf(a.weaponType) : s.POOL_COLOR_ORDER.indexOf(e.colorType) - s.POOL_COLOR_ORDER.indexOf(a.colorType)).map(e => `<div class="summon-pool-item ml-2">\n          <img class="summon-pool-item-img" src="../img/assets/icon/${e.colorType.toLowerCase()}-${e.weaponType.toLowerCase()}.png">\n          <span class="ml-2">${e.shortName||e.name}: ${e.title}</span></div>`).join("");
			$(e).html(r)
		}

		function k()
		{
			for (let e in y) y[e] = 0;
			p = 0, h = !0, t.clear().draw(), F(), v()
		}

		function v()
		{
			d = 0, h ? (h = !1, $(o.RATE_INPUT_FOCUS).val(l.rates.rateRarityFocus), $(o.RATE_INPUT_5).val(l.rates.rateRarity5), $(o.RATE_INPUT_FOCUS_4).val(l.rates.rateRarityFocus4), $(o.RATE_INPUT_4).val(l.rates.rateRarity4), $(o.RATE_INPUT_3).val(l.rates.rateRarity3)) : p >= 5 && (p -= 5, $(o.RATE_INPUT_FOCUS).val((parseFloat($(o.RATE_INPUT_FOCUS).val()) + l.rates.pityRateRarityFocus).toFixed(2)), $(o.RATE_INPUT_5).val((parseFloat($(o.RATE_INPUT_5).val()) + l.rates.pityRateRarity5).toFixed(2)), $(o.RATE_INPUT_FOCUS_4).val((parseFloat($(o.RATE_INPUT_FOCUS_4).val()) + l.rates.pityRateRarityFocus4).toFixed(2)), $(o.RATE_INPUT_4).val((parseFloat($(o.RATE_INPUT_4).val()) + l.rates.pityRateRarity4).toFixed(2)), $(o.RATE_INPUT_3).val((parseFloat($(o.RATE_INPUT_3).val()) + l.rates.pityRateRarity3).toFixed(2))), $(o.NEW_SESSION).attr("disabled", "disabled"),
				function ()
				{
					let e, a, r = [],
						t = parseFloat($(o.RATE_INPUT_FOCUS).val()) / 100,
						i = parseFloat($(o.RATE_INPUT_5).val()) / 100 + t;
					l.rates.rateRarityFocus4 ? (e = parseFloat($(o.RATE_INPUT_FOCUS_4).val()) / 100 + i, a = parseFloat($(o.RATE_INPUT_4).val()) / 100 + e) : (e = 0, a = parseFloat($(o.RATE_INPUT_4).val()) / 100 + i);
					for (let n = 0; n < 5; n++)
					{
						let n, o = Math.random();
						(n = o <= t ?
						...
						} :
						{
							hero: M(m.r3),
							rarity: 3
						}).iv = M(s.IV), n.color = n.hero.colorType.toLowerCase(), r.push(n)
					}
					return r
				}().forEach((e, a) =>
				{
					let r = $(`<img class="summon-orb" src="../${s.IMAGES[e.color]}" data-color="${e.color}">`).data("hero", e);
					$($(o.SUMMON_OPTION)[a]).empty().append(r)
				})
		}

		function S(e)
		{
			(l = $(e.currentTarget).data("val")).startDate = new Date(l.startDate), f()
		}
		...
		{
			let a = $(o.SUMMON_ORB);
			for (let e = 0; e < a.length; e++) w($(a[e]))
		}

		function R(e)
		{
			e.stopPropagation(), e.preventDefault();
			let a = $(e.currentTarget).find('input[type="checkbox"]');
			a.prop("checked", !a.is(":checked"));
			let r = $(e.currentTarget).data("val");
			$(o.SUMMON_TABLE).toggleClass("hide-" + r)
		}

		function w(e)
		{
			let a = e.data("hero");
			$(document).trigger("summon", [a.hero.name, a.hero.rarity]), e.replaceWith(`<div class="summon-hero">\n    <img class="summon-hero-frame" src="../img/assets/frame-rarity-${"focus-4"===a.rarity?4:a.rarity}.png">\n    <img class="summon-hero-portrait" src="../${a.hero.assets.portrait}">\n    <img class="summon-hero-background" src="../img/assets/background-rarity-${"focus-4"===a.rarity?"focus":a.rarity}.png">\n    <img class="summon-hero-rarity" src="../img/assets/star-rarity-${"focus-4"===a.rarity?4:a.rarity}.png">\n  </div>`), y.pulls++, y.orbs += s.ORB_PULL_COST[d++], "focus" === a.rarity || 5 === a.rarity ? (y.r5++, y.rf += "focus" === a.rarity ? 1 : 0, h = !0, p = 0) : p++;
			let r = t.row.add([y.pulls, a.hero.name, "focus" === a.rarity ? "Focus" : "focus-4" === a.rarity ? "Focus (4)" : a.rarity, a.iv.boon, a.iv.bane]).draw().node();
			return $(r).addClass("r-" + a.rarity), $(o.NEW_SESSION).removeAttr("disabled"), F(), a
		}

		function F()
		{
			let e = 0 === y.pulls ? "-" : (100 * y.r5 / y.pulls).toFixed(1) + "%",
				a = (y.orbs * s.ORB_MONEY_COST).toFixed(2),
				r = 0 === y.r5 ? "-" : (y.orbs / y.r5).toFixed(1),
				t = 0 === y.r5 ? "-" : "$" + (a / y.r5).toFixed(2);
			$("#total-summon-amt").text(y.pulls), $("#rarity5-summon-amt").text(y.r5), $("#focus-summon-amt").text(y.rf), $("#percent-summon-amt").text(e), $("#total-orbs-amt").text(y.orbs), $("#total-money-amt").text("$" + a), $("#avg-orbs-amt").text(r), $("#avg-money-amt").text(t)
		}

		function A()
		{
			let e, a, r = $(".snipe-target:checked"),
				t = [],
				i = 0,
				n = 0;
			$(document).trigger("snipe-start");
			for (let e = 0; e < r.length; e++) t.push($(r[e]).data("hero"));
			for (; B(t, i);) n++, (e = _(t)).length ? I(a = w($(e[0])), t) && ($(o.SUMMON_TABLE + " tbody tr:last-child").addClass("table-success"), i++) : d > 0 ? v() : w($(M($(o.SUMMON_ORB))));
			$(document).trigger("snipe-end", [n])
		}

		function B(e, a)
		{
			return $("#snipe-all").is(":checked") ? e.length > 0 : e.length > 0 && 0 === a
		}

		function _(e)
		{
			let a = new Set;
			e.forEach(e => a.add(e.colorType.toLowerCase()));
			let r = [...a].map(e => `${o.SUMMON_ORB}[data-color="${e}"]`).join(",");
			return $(r)
		}
		...
		function I(e, a)
		{
			for (let r = 0; r < a.length; r++)
				if (a[r].name === e.hero.name && "focus" === e.rarity) return a.splice(r, 1), !0;
			return !1
		}
		...
		function L(e)
		{
			let a = $(e.currentTarget).is(":checked"),
				r = $(e.currentTarget).closest(".custom-control").data("val");
			a ? (c.focusHeroes.push(r.name), $(o.CUSTOM_FOCUS).append(`<div class="focus-list-hero" data-name="${r.name}">\n        <img class="focus-list-hero-frame" src="../img/assets/frame-rarity-focus.png">\n        <img class="focus-list-hero-portrait" src="../${r.assets.portrait}">\n        <img class="focus-list-hero-background" src="../img/assets/background-rarity-focus.png">\n        </div>`)) : (c.focusHeroes.splice(c.focusHeroes.indexOf(r.name), 1), $(`.focus-list-hero[data-name="${r.name}"]`).remove())
		}

		function H()
		{
			let e = $(o.CUSTOM_SEARCH).val().trim().toLowerCase(),
				a = $(o.CUSTOM_LIST_DESC);
			for (let r = 0; r < a.length; r++) $(a[r]).toggleClass("d-none", -1 === $(a[r]).text().toLowerCase().indexOf(e))
		}

		function b()
		{
			c.rates.rateRarityFocus = parseInt($(o.CUSTOM_INPUT_FOCUS).val()), c.rates.rateRarity5 = parseInt($(o.CUSTOM_INPUT_5).val()), c.rates.rateRarityFocus4 = parseInt($(o.CUSTOM_INPUT_FOCUS_4).val()), c.rates.rateRarity4 = parseInt($(o.CUSTOM_INPUT_4).val()), c.rates.rateRarity3 = parseInt($(o.CUSTOM_INPUT_3).val()), 0 === c.rates.rateRarity5 && (c.rates.pityRateRarity5 = 0, c.rates.pityRateRarityFocus = .5)
		}

		function P(e)
		{
			let a = [$(o.CUSTOM_INPUT_FOCUS).val(), $(o.CUSTOM_INPUT_5).val(), $(o.CUSTOM_INPUT_FOCUS_4).val(), $(o.CUSTOM_INPUT_4).val(), $(o.CUSTOM_INPUT_3).val()];
			$(o.CUSTOM_MODAL).modal("hide"), window.history.pushState(null, null, "?focus=" + encodeURIComponent(c.focusHeroes.join(";")) + "&rates=" + encodeURIComponent(a.join(";"))), g(l = c, a), f(), $(o.SELECT_BANNER).selectable("text", "Custom Banner")
		}
		...
		function C(e)
		{
			let a = new RegExp("[?&]" + e + "=([^&#]*)").exec(window.location.href);
			return null == a ? "" : decodeURIComponent(a[1]) || 0
		}

		function N(e, a)
		{
			a.append(`<div class="dropdown-header">${e.date}</div>`);
			for (let r = 0; r < e.banners.length; r++) $(`<div class="dropdown-item">${e.banners[r].name}</div>`).data("val", e.banners[r]).data("tokens", e.banners[r].focusHeroes.join(" ").toLowerCase()).appendTo(a)
		}! function ()
		{
			let e = n.getFirstBanner();
			t = $(o.SUMMON_TABLE).DataTable(
			{
				paging: !1,
				searching: !1,
				info: !1,
			...
			}), $(o.SELECT_BANNER).selectable(
			{
				data: n.getAllBanners(),
				optionGenerator: N,
				text: e.name,
				value: e,
			...
			if (a.length)
			{
				l = x(a.split(";")), $(o.SELECT_BANNER).selectable("text", l.name);
				let e = C("rates").split(";");
				5 === e.length && g(l, e)
			}
			else(l = n.getFirstBanner()).startDate = new Date(l.startDate);
			f(), i.getAllHeroes().forEach(e =>
			{
				$(`<label class="custom-control custom-checkbox">\n        <input type="checkbox" class="custom-control-input">\n        <span class="custom-control-indicator"></span>\n        <span class="custom-control-description">${e.name}</span>\n        </label>`).data("val", e).appendTo(o.CUSTOM_LIST)
			}), $(o.SELECT_BANNER).on("select", S), $(o.NEW_SESSION).on("click", v), $(o.SUMMON_OPTION).on("click", o.SUMMON_ORB, T), $(o.SUMMON_ALL).on("click", D), $(o.RESET).on("click", k), $(o.SNIPE).on("click", A), $(o.CUSTOM_LIST).on("change", "input", L), $(o.CREATE_BANNER).on("click", P), $(o.CUSTOM_SEARCH).on("keyup", H), $(o.CUSTOM_RATE_INPUT).on("change", b), $(o.TABLE_FILTER_ITEM).on("click", R)
		}()
	},
	{
		"../data/banner-access.js": 1,
		"../data/hero-access.js": 4,
		"./elements.js": 6,
		"./values.js": 8
	}],
	8: [function (e, a, r)

module.exports = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Swift Sparrow 1", rarity: 5 },
      { name: "Swift Sparrow 2", rarity: 5 },
      { name: "Disarm Trap 1", rarity: 5 },
      { name: "Disarm Trap 2", rarity: 5 },
      { name: "Disarm Trap 3", rarity: 5 },
      { name: "Hone Atk 1", rarity: 5 },
      { name: "Hone Atk 2", rarity: 5 },
      { name: "Hone Fliers", rarity: 5 }          
    ],
    stats: {
      level1: { hp: 19, atk: 7, spd: 10, def: 4, res: 5 },
      level40: { hp: [ 35, 38, 42 ], atk: [ 34, 37, 41 ], spd: [ 31, 34, 37 ], def: [ 13, 17, 20 ], res: [ 26, 29, 32 ] }
    }
  },
  {
    ...
    skills: [
      { name: "Wind", rarity: 5 },
      { name: "Elwind", rarity: 5 },
      { name: "Rexcalivur", rarity: 5 },
      { name: "Veðrfölnir's Egg", rarity: 5 },     
      { name: "Night Sky", rarity: 5 },     
      { name: "Glimmer", rarity: 5 },
      { name: "G Duel Flying 1", rarity: 5 },
      { name: "G Duel Flying 2", rarity: 5 },
      { name: "G Duel Flying 3", rarity: 5 },     
      { name: "Chill Res 1", rarity: 5 },     
      { name: "Chill Res 2", rarity: 5 },
      { name: "Chill Res 3", rarity: 5 }     
    ],
    stats: {
      level1: { hp: 16, atk: 9, spd: 10, def: 3, res: 6 },
      level40: { hp: [ 34, 38, 41 ], atk: [ 32, 35, 38 ], spd: [ 33, 36, 39 ], def: [ 12, 16, 19 ], res: [ 22, 25, 29 ] }
    }
  },
  {
    ...
    skills: [
      { name: "Iron Lance", rarity: 5 },
      { name: "Steel Lance", rarity: 5 },
      { name: "Flashing Carrot", rarity: 5 },
      { name: "Flashing Carrot+", rarity: 5 },     
      { name: "Reposition", rarity: 5 },     
      { name: "Spd/Def Link 1", rarity: 5 },
      { name: "Spd/Def Link 2", rarity: 5 },
      { name: "Spd/Def Link 3", rarity: 5 },
      { name: "Flier Guidance 1", rarity: 5 },     
      { name: "Flier Guidance 2", rarity: 5 },     
      { name: "Flier Guidance 3", rarity: 5 }
    ],
    stats: {
      level1: { hp: 18, atk: 9, spd: 8, def: 6, res: 6 },
      level40: { hp: [ 39, 42, 45 ], atk: [ 30, 33, 36 ], spd: [ 35, 38, 42 ], def: [ 24, 28, 31 ], res: [ 18, 21, 24 ] }
    }
  },
  {
    name: "Caineghis",
    ...
    skills: [
      { name: "Lion King Fang", rarity: 5 },
      { name: "Glowing Ember", rarity: 5 },
      { name: "Bonfire", rarity: 5 },
      { name: "Distant Def 1", rarity: 5 },     
      { name: "Distant Def 2", rarity: 5 },     
      { name: "Distant Def 3", rarity: 5 },
      { name: "Distant Def 4", rarity: 5 },
      { name: "Vengeful Fighter 1", rarity: 5 },
      { name: "Vengeful Fighter 2", rarity: 5 },     
      { name: "Vengeful Fighter 3", rarity: 5 },     
      { name: "Distant Guard 1", rarity: 5 },
    ...
    stats: {
      level1: { hp: 23, atk: 9, spd: 4, def: 11, res: 8 },
      level40: { hp: [ 44, 47, 50 ], atk: [ 34, 37, 40 ], spd: [ 20, 23, 27 ], def: [ 34, 37, 40 ], res: [ 26, 30, 33 ] }
    }
  },
  {
    name: "Lethe",
    ...
    skills: [
      { name: "Brazen Cat Fang", rarity: 5 },
      { name: "New Moon", rarity: 5 },
      { name: "Moonbow", rarity: 5 },
      { name: "Spd/Def Solo 1", rarity: 5 },     
      { name: "Spd/Def Solo 2", rarity: 5 },     
      { name: "Spd/Def Solo 3", rarity: 5 },
      { name: "Hone Atk 1", rarity: 5 },
      { name: "Hone Atk 2", rarity: 5 },
      { name: "Hone Beasts", rarity: 5 }
    ],
    stats: {
      level1: { hp: 17, atk: 9, spd: 10, def: 4, res: 6 },
      level40: { hp: [ 38, 41, 44 ], atk: [ 30, 33, 36 ], spd: [ 35, 38, 41 ], def: [ 22, 26, 29 ], res: [ 15, 19, 22 ] }
    }
  },
  {
    name: "Ranulf",
    ...
    stats: {
      level1: { hp: 16, atk: 8, spd: 11, def: 7, res: 4 },
      level40: { hp: [ 37, 40, 43 ], atk: [ 26, 30, 33 ], spd: [ 34, 37, 40 ], def: [ 30, 33, 36 ], res: [ 13, 17, 20 ] }
    }
  },
  {
    name: "Mordecai",
    ...
    skills: [
      { name: "Sabertooth Fang", rarity: 5 },
      { name: "Smite", rarity: 5 },
      { name: "Atk/Def Link 1", rarity: 5 },
      { name: "Atk/Def Link 2", rarity: 5 },
      { name: "Atk/Def Link 3", rarity: 5 },     
      { name: "Beast Exp. 1", rarity: 5 },     
      { name: "Beast Exp. 2", rarity: 5 },
      { name: "Beast Exp. 3", rarity: 5 }
    ],
    stats: {
      level1: { hp: 19, atk: 11, spd: 5, def: 9, res: 5 },
      level40: { hp: [ 44, 47, 50 ], atk: [ 34, 37, 40 ], spd: [ 21, 24, 28 ], def: [ 36, 39, 43 ], res: [ 17, 20, 23 ] }
    }
  },
  {
    name: "Haar",
  ...
  },
  {
    ...
    stats: {
      level1: { hp: 21, atk: 8, spd: 11, def: 8, res: 7 },
      level40: { hp: [ 39, 43, 46 ], atk: [ 26, 30, 33 ], spd: [ 34, 37, 40 ], def: [ 26, 30, 33 ], res: [ 32, 35, 38 ] }
    }
  },
  {
    ...
    skills: [
      ...
      { name: "Steel Dagger", rarity: 5 },
      { name: "Silver Dagger", rarity: 5 },
      { name: "Sæhrímnir", rarity: 5 },
      { name: "Chilling Wind", rarity: 5 },
      { name: "Iceberg", rarity: 5 },
      { name: "AR-D Atk/Res 1", rarity: 5 },
      { name: "AR-D Atk/Res 2", rarity: 5 },
      { name: "AR-D Atk/Res 3", rarity: 5 },
      { name: "Armor March 1", rarity: 5 },
      { name: "Armor March 2", rarity: 5 },
      { name: "Armor March 3", rarity: 5 }
    ],
    stats: {
      level1: { hp: 19, atk: 12, spd: 5, def: 7, res: 10 },
      level40: { hp: [ 40, 43, 46 ], atk: [ 35, 38, 41 ], spd: [ 19, 22, 25 ], def: [ 25, 29, 32 ], res: [ 35, 38, 41 ] }
    }
  },
  {
    ...
    skills: [
      { name: "Iron Lance", rarity: 5 },
      { name: "Steel Lance", rarity: 5 },
      { name: "Luncheon Lance", rarity: 5 },
      { name: "Luncheon Lance+", rarity: 5 },
      { name: "Pivot", rarity: 5 },
      { name: "AR-O Atk/Def 1", rarity: 5 },
      { name: "AR-O Atk/Def 2", rarity: 5 },
      { name: "AR-O Atk/Def 3", rarity: 5 },
      { name: "Wary Fighter 1", rarity: 5 },
      { name: "Wary Fighter 2", rarity: 5 },
      { name: "Wary Fighter 3", rarity: 5 }
    ],
    stats: {
      level1: { hp: 25, atk: 9, spd: 6, def: 12, res: 3 },
      level40: { hp: [ 48, 51, 54 ], atk: [ 18, 21, 24 ], spd: [ 18, 21, 24 ], def: [ 39, 42, 46 ], res: [ 19, 22, 26 ] }
    }
  },
  {
    ...
    stats: {
      ...
      level40: { hp: [ 32, 35, 39 ], atk: [ 33, 36, 39 ], spd: [ 21, 24, 28 ], def: [ 11, 14, 18 ], res: [ 31, 34, 37 ] }
    }
  },
  {
  ...
  },
  {
    ...
    stats: {
      ...
      level40: { hp: [ 39, 42, 45 ], atk: [ 29, 33, 36 ], spd: [ 38, 41, 45 ], def: [ 25, 29, 32 ], res: [ 20, 23, 37 ] }
    }
  },
  {
  ...
  },
  {
    ...
    stats: {
      ...
      level40: { hp: [ 38, 41, 44 ], atk: [ 33, 36, 39 ], spd: [ 30, 33, 36 ], def: [ 16, 19, 22 ], res: [ 25, 28, 31 ] }
    }
  },
  {
    ...
    moveType: "Infantry", 
    assets: {
      portrait: "img/heroes-portrait/75px-Icon_Portrait_Corrin (F) (Darkness Within).png",
